...
LOCAL_APPS = [
    "admin.inventory_management.apps.InventoryManagementConfig",
    "admin.marketplace_integration.apps.MarketplaceIntegrationConfig",
    "admin.logistics.apps.LogisticsConfig",
    "admin.analytics_reporting.apps.AnalyticsReportingConfig",
    "admin.user_role_management.apps.UserRoleManagementConfig",
    "admin.feedback_processing.apps.FeedbackProcessingConfig",
    "admin.auxiliary_services.apps.AuxiliaryServicesConfig",
]
...
DB_DATABASE = os.environ.get("DB_DATABASE", "pahestor_db")

IS_DB_AVAIL = all([DB_USERNAME, DB_PASSWORD, DB_HOST, DB_PORT, DB_DATABASE])
...
JAZZMIN_SETTINGS = {
    ...
    "site_header": "Pahestor Admin",
    # Title on the brand (19 chars max) (defaults to
    # current_admin_site.site_header if absent or None)
    "site_brand": "Pahestor",
    # Logo to use for your site, must be present in static files, used for
    # brand on top left
    # "site_logo": "https://chat.openai.com/g/g-2fkFE8rbu-dall-e/c/5fba7992
    # -e4f6-4be5-9ce1-71c939682200",
    # Logo to use for your site, must be present in static files, used for
    ...
    "welcome_sign": "Welcome to the Pahestor",
    # Copyright on the footer
    "copyright": "EvoQ Soft",
    # List of model admins to search from the search bar, search bar omitted
    # if excluded
    ...
    # https://fontawesome.com/icons?d=gallery&m=free&v=5.0.0,5.0.1,5.0.10,
    # 5.0.11,5.0.12,5.0.13,5.0.2,5.0.3,5.0.4,5.0.5,5.0.6,5.0.7,5.0.8,5.0.9,
    # 5.1.0,5.1.1,5.2.0,5.3.0,5.3.1,5.4.0,5.4.1,5.4.2,5.13.0,5.12.0,5.11.2,
    # 5.11.1,5.10.0,5.9.0,5.8.2,5.8.1,5.7.2,5.7.1,5.7.0,5.6.3,5.5.0,5.4.2
    ...
    "icons": {
        ...
        "inventory_management.Category": "fas fa-boxes",
        "inventory_management.StockRecord": "fas fa-industry",
        "marketplace_integration": "fas fa-user",
        "logistics": "fas fa-user",
        "analytics_reporting": "fas fa-user",
        "user_role_management": "fas fa-user",
        "feedback_processing": "fas fa-user",
        "auxiliary_services": "fas fa-user",
    },
    ...
    "custom_css": None,
    "custom_js": None,
    # Whether to link font from fonts.googleapis.com (use custom_css to
    # supply font otherwise)
    ...
    # Change view #
    ###############
    # Render out the change view as a single form, or in tabs, current
    # options are
    # - single
